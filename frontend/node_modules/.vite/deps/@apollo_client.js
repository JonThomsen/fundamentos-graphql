...
var SYMBOL_ITERATOR = typeof Symbol === "function" ? Symbol.iterator : "@@iterator";
var SYMBOL_ASYNC_ITERATOR = typeof Symbol === "function" ? Symbol.asyncIterator : "@@asyncIterator";
...
var Parser = function() {
  ...
  _proto.parseImplementsInterfaces = function parseImplementsInterfaces() {
    ...
    if (this.expectOptionalKeyword("implements")) {
      ...
      } while (this.expectOptionalToken(TokenKind.AMP) || ((_this$_options2 = this._options) === null || _this$_options2 === void 0 ? void 0 : _this$_options2.allowLegacySDLImplementsInterfaces) === true && this.peek(TokenKind.NAME));
    }
    return types;
  };
...
function isCollection(obj) {
  if (obj == null || _typeof4(obj) !== "object") {
    return false;
  }
  var length = obj.length;
  if (typeof length === "number" && length >= 0 && length % 1 === 0) {
